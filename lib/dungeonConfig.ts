...
export const DUNGEON_LEVELS: DungeonLevelConfig[] = [
  {
    ...
    boss: { name: "Crypt Warden", emoji: "🪦", hp: [160, 220], atk: [18, 26], def: [16, 22], lck: [12, 18] },
    itemDropRate: 0.16,
    battleGold: [10, 18],
    treasureGold: [14, 26],
  ...
  },
  {
    ...
    boss: { name: "Forest Stalker", emoji: "🌲", hp: [220, 300], atk: [22, 30], def: [18, 26], lck: [14, 22] },
    itemDropRate: 0.18,
    battleGold: [12, 22],
    treasureGold: [18, 32],
    unlockRewardRarity: "Common",
  },
  {
    ...
    boss: { name: "Goblin King", emoji: "👺", hp: [300, 420], atk: [28, 38], def: [22, 32], lck: [18, 26] },
    itemDropRate: 0.22,
    battleGold: [16, 28],
    treasureGold: [22, 40],
  ...
  },
  {
    ...
    boss: { name: "Orc Warlord", emoji: "👹", hp: [420, 560], atk: [38, 52], def: [30, 42], lck: [22, 32] },
    itemDropRate: 0.25,
    battleGold: [20, 34],
    treasureGold: [26, 50],
    unlockRewardRarity: "Rare",
  },
  {
    ...
    boss: { name: "Tower Specter", emoji: "🗼", hp: [560, 740], atk: [52, 68], def: [40, 56], lck: [28, 40] },
    itemDropRate: 0.29,
    battleGold: [24, 40],
    treasureGold: [34, 64],
  ...
  },
  {
    ...
    boss: { name: "Shadow Lord", emoji: "🌑", hp: [760, 980], atk: [70, 90], def: [56, 74], lck: [40, 58] },
    itemDropRate: 0.32,
    battleGold: [28, 46],
    treasureGold: [40, 78],
    unlockRewardRarity: "Epic",
  },
  {
    ...
    boss: { name: "Ancient Drake", emoji: "🐉", hp: [980, 1260], atk: [92, 118], def: [74, 98], lck: [58, 82] },
    itemDropRate: 0.36,
    battleGold: [32, 52],
    treasureGold: [52, 95],
  ...
  },
  {
    ...
    boss: { name: "Void Herald", emoji: "⚫", hp: [1260, 1540], atk: [120, 150], def: [98, 124], lck: [74, 102] },
    itemDropRate: 0.4,
    battleGold: [36, 58],
    treasureGold: [60, 110],
    unlockRewardRarity: "Legendary",
  },
  {
    ...
    boss: { name: "Hellkeeper", emoji: "🔥", hp: [1540, 1920], atk: [150, 188], def: [124, 154], lck: [96, 126] },
    itemDropRate: 0.44,
    battleGold: [40, 66],
    treasureGold: [70, 130],
    unlockRewardRarity: "Legendary",
  },
  {
    ...
    boss: { name: "Final Abyss", emoji: "⚡", hp: [2000, 2600], atk: [200, 260], def: [160, 220], lck: [130, 180] },
    itemDropRate: 0.5,
    battleGold: [45, 75],
    treasureGold: [85, 160],
